...
<div id="fileLink" style="display:none;">
    ...
    {
        	$html .= '<div class="panel" style="background-color: #DFEFF8;"><h3><i class="icon-question-sign"></i> '.$this->l('How to export orders in CSV file ?').'</h3>
	 ...
	 <div class="panel" style="background-color: #F4F7F7;"><h3><i class="icon-question-sign"></i> '.$this->l('Export Orders settings').'</h3>
			...
			<input type="button" name="submitDateDay" id="submitDateDay" class="button" value="'.$this->l('Day').'" onclick="getDay();">
					...
					<input type="button" name="submitDateMonthPrev" class="button" value="'.$this->l('Month-1').'" style="margin-top:2px" onclick="getMonth1();">
					<input type="button" name="submitDateYearPrev" class="button" value="'.$this->l('Year-1').'" style="margin-top:2px" onclick="getYear1();"><br>
				<input type="text" class="datepicker" name="sp_from" value="" style="text-align: center; width:200px;" id="sp_from" onchange="showOrders();" />
               <label>'.$this->l('To:').'</label>
				<input type="text" class="datepicker" name="sp_to" value="" style="text-align: center; width:200px;" id="sp_to" onchange="showOrders();" />
			</div>';
			...
			$html .= '<label>'.$this->l('Export State :').'</label>
					<div class="margin-form" >
					<select id="stateExport" name="stateExport" style="width:200px;" onchange="showOrders(this.value);">
					<option value="0" selected>'.$this->l('All').'</option>';
					foreach($states as $state)
					{
						$html .= '<option value="'.$state['id_order_state'].'">'.$state['name'].'</option>';
						...
						$html .= '</select>
                        <span style="clear: both; color: #7F7F7F; font-family: Georgia; font-size: 11px; font-style: italic;"> ' . $this->l('(Select state for which you want to display orders you want to export)') . '</span>
