...
class DBQueryHelper extends ObjectModel
{
	...
	*/
	public static function getOrderDetails($id_order)
	{
		...
		$sqlStr = '
			SELECT *, pl.name, c.firstname, c.lastname, c.email, a.postcode, a.city, a.id_country, a.phone, a.phone_mobile, a.address1, a.address1, a.company  FROM '._DB_PREFIX_.'order_detail od'.
			' INNER JOIN '._DB_PREFIX_.'orders o ON od.id_order = o.id_order '.
			' INNER JOIN '._DB_PREFIX_.'customer c ON o.id_customer = c.id_customer '.
			' INNER JOIN '._DB_PREFIX_.'address a ON c.id_customer = a.id_customer '.
			' INNER JOIN '._DB_PREFIX_.'product_lang pl ON od.id_product = pl.id_prodcut AND pl.id_lang = 1'.
